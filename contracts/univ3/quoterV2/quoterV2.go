...
func (_QuoterV2 *QuoterV2Caller) QuoteExactInputSingle(opts *bind.CallOpts, params IQuoterV2QuoteExactInputSingleParams) (*big.Int, error) {
	var out []interface{}
...
// QuoteExactOutput 把上面的QuoteExactOutput注释了，重写的新方法
...
func (_QuoterV2 *QuoterV2Caller) QuoteExactOutputSingle(opts *bind.CallOpts, params IQuoterV2QuoteExactOutputSingleParams) (*big.Int, error) {
	var out []interface{}
