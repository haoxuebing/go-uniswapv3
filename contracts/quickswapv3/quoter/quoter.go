...
func (_Quoter *QuoterCaller) QuoteExactInputSingle(opts *bind.CallOpts, tokenIn common.Address, tokenOut common.Address, amountIn *big.Int, limitSqrtPrice *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Quoter.contract.Call(opts, &out, "quoteExactInputSingle", tokenIn, tokenOut, amountIn, limitSqrtPrice)
	if err != nil {
...
func (_Quoter *QuoterCaller) QuoteExactOutputSingle(opts *bind.CallOpts, tokenIn common.Address, tokenOut common.Address, amountOut *big.Int, limitSqrtPrice *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Quoter.contract.Call(opts, &out, "quoteExactOutputSingle", tokenIn, tokenOut, amountOut, limitSqrtPrice)
	if err != nil {
		return big.NewInt(0), err
	}
